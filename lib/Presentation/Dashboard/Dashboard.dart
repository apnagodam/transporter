...
RowSuper(fill: true, children: [
 ...
 SizedBox(
                       ...
                       data.data?[index].poId==null?SizedBox():   RowSuper(
                              fill: true,
                              alignment: Alignment.center,
                              children: [
                                Text(
                          ...
                          const SizedBox(
                            height: 10,
                              ...
                              data.data?[index].truckNumber == null && data.data?[index].driverName==null?
                              AnimatedButton(
                                height: 35,
                                color: ColorConstants.primaryColorWSP,
                                ...
                                borderWidth: 1,
                                onTap: () async {
                                 ref.watch(truckDriverProvider.future).then((truckData)=>showBarModalBottomSheet(context: context, builder: (modalContext)=>SafeArea(child: Padding(padding: Pad(all: 10),child: ColumnSuper(children: [
                                  truckSelection(ref, context, truckData.truckData??[]),
                                  SizedBox(height: 10,),
                                  driverSelection(ref, context, truckData.driverData??[]),
                                  SizedBox(height: 10,),
                                  AnimatedButton(
                                      height: 35,
                                      color: ColorConstants.primaryColorWSP,
                                ...
                                child: Text(
                                  ...
                                  : data.data?[index].weight != null && data.data?[index].tripStart==null? AnimatedButton(
                                      height: 35,
                                      color: ColorConstants.primaryColorWSP,
                                      width: MediaQuery.of(context).size.width /
                                          1.2,
                                      ...
                                      onTap: () async {
                                          ...
                                          ref.watch(startTripProvider(tripRequestId:"${data.data?[index].id}" ).future).then((value){
                                            if(value['status'].toString()=="1"){
                                              successToast(context, value['message'.toString()]);
                                              ref.invalidate(tripsListProvider);
                                            }
                                    ...
                                    data.data?[index].weight != null && data.data?[index].tripStart!=null &&data.data?[index].tripEnd == null ? AnimatedButton(
                                      height: 35,
                                      color: ColorConstants.primaryColorWSP,
                                      width: MediaQuery.of(context).size.width /
                                          1.2,
...
if(form.currentState!.validate()){
                                    ...
                                    data.data?[index].tripEnd!=null && data.data?[index].tripStart!=null  ?Text(
                                        "Completed",
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
                                            color: ColorConstants.primaryColorDriver,
                        ...
                        popupProps: PopupProps.menu(
                            ...
                            menuProps: MenuProps(
                                shape: RoundedRectangleBorder(
                                    side: const BorderSide(color: ColorConstants.primaryColorWSP),
  ...
  driverSelection(WidgetRef ref, BuildContext context,List<DriverDatum?> data)=>DropdownSearch<DriverDatum?>(
                        popupProps: PopupProps.menu(
                            searchFieldProps: const TextFieldProps(
                                autofocus: true,
                                cursorColor: ColorConstants.primaryColorWSP,
