...
class Endtrips extends ConsumerStatefulWidget {
  const Endtrips({super.key});

  @override
  ConsumerState<Endtrips> createState() => _EndtripsState();
}

class _EndtripsState extends ConsumerState<Endtrips> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('endTrip'.tr()),
        centerTitle: false,
      ),
      body: SafeArea(
